...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="Sign Language To Text and Speech Conversion",fg="black", font=("Arial", 30, "bold"))
        ...
        self.T1.config(text="Character :", fg="green",font=("Arial", 30, "bold"))
        ...
        self.T3.config(text="Sentence :",fg="blue", font=("Arial", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=700)
        self.T4.config(text="Suggestions :", fg="red", font=("Arial", 30, "bold"))
        ...
        self.speak.config(text="Speak", font=("Arial", 20,"bold"), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1205, y=630)
        self.clear.config(text="Clear", font=("Arial", 20,"bold"), wraplength=100, command=self.clear_fun)
